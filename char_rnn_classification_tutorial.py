...
# for fork # https://github.com/pytorch/tutorials/blob/main/intermediate_source/char_rnn_classification_tutorial.py
# https://python-scripts.com/pytorch-rnn
